...
import { Typography, TextField, Box, IconButton, Switch, FormControlLabel, Accordion, AccordionSummary, AccordionDetails } from '@mui/material';
import AddCircleOutlineIcon from '@mui/icons-material/AddCircleOutline';
import RemoveCircleOutlineIcon from '@mui/icons-material/RemoveCircleOutline';
import ActionPropertiesCard from './Action_card';

const VehicleTypeEdgePropertyCard = ({ property, updateElement, nodeId, id, removeParameter }) => {
  ...
  const handleBlur = (field, value) => {
    ...
    updateElement(nodeId, { vehicleTypeEdgeProperties: updatedProperty });
  };
  ...
  const updateAction = (index, updatedAction) => {
    ...
    updateElement(nodeId, { vehicleTypeEdgeProperties: { ...property, actions: updatedActions } });
  };
